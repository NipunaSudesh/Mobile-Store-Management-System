...
export const EditFeatureMobile = () => {
    ...
    const handleUpdate = async (e) => {
        e.preventDefault();
        try {
            await axios.patch(`http://localhost:5000/feature-mobile/update/${id}`, mobile);
    ...
    return (
        <div id='addFeatured' className='flex h-screen items-center justify-center'>
            <div className='flex h-auto w-[700px] flex-col items-center justify-center py-2 rounded shadow-2xl border-2'>
                <h1 className='text-center py-2 bg-green-400 w-full text-2xl mb-4 uppercase'>update Featured MOBILE PHONES</h1>
                {message && (
